...
class Band(Base):
    ...
    # Per-band sheet music store configuration, stored as a JSON string with
    # the shape {"patterns": {...}, "instruments": {...}}. See
    # examples/sheet-store-perfecttime.json for a reference layout.
    sheet_store: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
