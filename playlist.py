...
production = True #if 'PLAYLIST_PRODUCTION' in os.environ else False
img_cache_path = 'cache/'
#host, port, proxy_path = ('127.0.0.1', 8012, '/playlist') if production else ('127.0.0.1', 8013, '')
host, port, proxy_path = ('0.0.0.0', 8012, '/playlist') if production else ('0.0.0.0', 8013, '')
...
@app.route(proxy_path + '/play/<playlistId:.*>')
